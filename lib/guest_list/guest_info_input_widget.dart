...
class _GuestInfoInputWidgetState extends State<GuestInfoInputWidget> {
  ...
  final String _firstNameInputHintText =
      'Enter your first name' + ' (Only letters are allowed)';
  final String _lastNameInputHintText =
      'Enter your last name' + ' (Only letters are allowed)';
  ...
  Widget textFormField(TextEditingController controller, String hintText,
      String emptyInputAlert, String onlySpaceInputAlert) {
  ...
  Widget nameInputColumn(
      String prefix, TextEditingController controller, String hintText) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Styles.text(prefix, Styles.middleTextWithDefaultColor),
        Container(
          child: textFormField(controller, hintText, _emptyInputAlertTxt,
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: nameInputColumn(_firstNameTextPrefix,
                      _guestFirstNameController, _firstNameInputHintText),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 8, vertical: 16),
                  child: nameInputColumn(_lastNameTextPrefix,
                      _guestLastNameController, _lastNameInputHintText),
                ),
                ...
                GuestCheckInButtonWidget(
                  ...
                  checkDuplicatedGuest: widget.checkDuplicatedGuest,
                ),
              ],
            )));
  }
